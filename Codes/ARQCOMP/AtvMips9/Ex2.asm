.data
	...
	numText: .asciiz "\nNumero de caracteres (contando quebras de linha)do vetor: "
...
lAloca:
	...
	beq $t2, 13, proxNum	# if ($t2 == 13) goto proxNums
	beq $t2, 10, proxNum	# if ($t2 == 10) goto proxNums
...
charToInt:
	beq $t2, 13, espaco	# if ($t2 == 10) goto ehEspaco
	beq $t2, 10, espaco	# if ($t2 == 10) goto ehEspaco
...
lQuantia:
	...
	li $a2, 1 # Numero de caracteres a serem lidos
	li $v0, 14 # Codigo para ler um arquivo
	syscall # le o arquivo 
