...
/** Remove o elemento da lista L indicado por p.  p deve indicar um 
 elemento existente em L. O comprimento da lista e' diminuido de 1 elemento. */
...
typedef bool (*Check)(Item item,double x1,double y1,double x2,double y2);
